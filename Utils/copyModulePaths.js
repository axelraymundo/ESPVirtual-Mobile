...
export const copyModulePaths = async () => {
  ...
  if (Platform.OS === 'android') {
    ...
    const files = [
      ...
      //quiz_engine bg
      `${interior2}/quiz_engine/bg/ctn_post.png`,
      `${interior2}/quiz_engine/bg/ctn_title.png`,

      //quiz_engine image
      `${interior2}/quiz_engine/image/image.png`,

      //quiz_engine ui confetti
      `${interior2}/quiz_engine/ui/confetti/confetti-02.png`,
      `${interior2}/quiz_engine/ui/confetti/confetti-04.png`,
      `${interior2}/quiz_engine/ui/confetti/confetti-05.png`,
      `${interior2}/quiz_engine/ui/confetti/confetti-06.png`,
      `${interior2}/quiz_engine/ui/confetti/ui_icn_confetti_bg.png`,

      //quiz_engine ui settings
      `${interior2}/quiz_engine/ui/settings/btn_quiz_cancel.png`,
      `${interior2}/quiz_engine/ui/settings/btn_quiz_no.png`,
      `${interior2}/quiz_engine/ui/settings/btn_quiz_yes.png`,
      `${interior2}/quiz_engine/ui/settings/ctn_quiz_settings.png`,

      //other on quiz_engine ui
      `${interior2}/quiz_engine/ui/btn_exit.png`,
      `${interior2}/quiz_engine/ui/btn_keepquiz.png`,
      `${interior2}/quiz_engine/ui/ui_btn_choice_normal_long.png`,
      `${interior2}/quiz_engine/ui/ui_btn_choice_pressed_green_long.png`,
      `${interior2}/quiz_engine/ui/ui_btn_choice_pressed_red_long.png`,
      `${interior2}/quiz_engine/ui/ui_ctn_timer_bar.png`,
      `${interior2}/quiz_engine/ui/ui_ctn_timer.png`,
      `${interior2}/quiz_engine/ui/ui_icn_heart_empty.png`,
      `${interior2}/quiz_engine/ui/ui_icn_heart_normal.png`,
      `${interior2}/quiz_engine/ui/ui_icn_timer_score.png`,
   ...
   `${images2}/ui/exit_button/shadow_right.png`,
      ...
      `${images2}/ui/recovery/recovery email_retry.png`,
      `${images2}/ui/recovery/recovery email_send.png`,
